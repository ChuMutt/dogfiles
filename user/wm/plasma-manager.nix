{
  programs.plasma6 = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-b49ec617-7be5-4224-a07f-a8fedef227ee" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,9,3,22,1,56.027";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."b49ec617-7be5-4224-a07f-a8fedef227ee" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "b49ec617-7be5-4224-a07f-a8fedef227ee";
      ...
      "kwinrc"."Desktops"."Id_1" = "325d1e88-04c4-4a82-b47a-a894a74e2841";
      "kwinrc"."Desktops"."Number" = 1;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."LatitudeFixed" = 35.725190839694655;
      "kwinrc"."NightColor"."LongitudeFixed" = "-92.03007518796993";
      "kwinrc"."NightColor"."Mode" = "Location";
      "kwinrc"."NightColor"."NightTemperature" = 5800;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/9f3084f1-64f4-59ba-bbac-7249dba1243f"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "spectaclerc"."ImageSave"."lastImageSaveLocation" = "file:///home/chu/Pictures/Screenshots/Screenshot_20240923_135745.png";
      "spectaclerc"."ImageSave"."translatedScreenshotsFolder" = "Screenshots";
      "spectaclerc"."VideoSave"."translatedScreencastsFolder" = "Screencasts";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/chu/.config/dogfiles/hosts/dogleash/configuration.nix";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 513;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 513;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 790;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,511,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = "file:///home/chu/.config/dogfiles/hosts/dogleash/configuration.nix";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "file:///home/chu/.config/dogfiles/hosts/dogleash/configuration.nix";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 0" = "file:///home/chu/.config/dogfiles/hosts/dogleash/configuration.nix";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/chu\\/.config\\/dogfiles\\/hosts\\/dogleash\\/configuration.nix"."CursorColumn" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/chu\\/.config\\/dogfiles\\/hosts\\/dogleash\\/configuration.nix"."CursorLine" = 14;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/chu\\/.config\\/dogfiles\\/hosts\\/dogleash\\/configuration.nix"."ScrollLine" = 71;
