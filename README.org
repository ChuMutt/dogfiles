...
Overall architecture, themes, & 99% of this code was written by LibrePhoenix.
...
* To-Do
** TODO [#C] better modularization / system profiles that don't repeat themselves
** TODO [#C] actual profiles that aren't just everything you need thrown into /work profile
** DONE doom install script with my dotfiles
** TODO [#C] wallpaper
** TODO [#C] opentabletdriver
** TODO [#C] ardour / plugins / music
** TODO [#A] hard drives / fstab
** TODO [#B] zfs server / nfs connections
** TODO [#B] agenix
** TODO [#C] blender
** TODO impermanence
...
** Dogfiles stable notes
*** Resolution for VM when not fully maximized is 1914x987
** DONE doom path added to path
done via alias
** DONE Error caused by user's config or system: doom/config.el, (file-missing Cannot open load file No such file or directory /home/chu/.local/share/roswell/helper.el)
*** DONE roswell install script
** DONE telegram
...
#+end_src
* DEPRECATED Old Literate README.org
#+tangle: no

#+name: deprecated-literate-readme
#+begin_src org
,* Installation
