...
#+name: patch-flake-and-attune-to-user
#+begin_src sh
...
#+name: harden-core-configuration
#+begin_src sh
sudo $SCRIPT_DIR/harden.sh $SCRIPT_DIR; # TODO Currently no harden.sh
#+end_src

Rebuild system.

#+name: nixos-rebuild-system-with-flake
#+begin_src sh
...
#+begin_src sh :noweb yes :eval no :tangle ./install
<<clone-dotfiles>>
<<generate-hardware-config>>
<<uefi-or-bios-check>>
<<patch-flake-and-attune-to-user>>
<<edit-flake-prompt>>
<<harden-core-configuration>>
<<nixos-rebuild-system-with-flake>>
