...
** TODO lf declarative rather than tangling in luke lf config
** TODO telegram
...
** lang/
*** cc/cc.nix
#+begin_src :mkdirp yes :tangle ./user/lang/cc/cc.nix
{ pkgs, ... }:
...
#+end_src
*** lisp/lisp.nix
#+begin_src :mkdirp yes :tangle ./user/lang/lisp/lisp.nix
{ pkgs, ... }:
...
#+end_src
*** rust/rust.nix
#+begin_src :mkdirp yes :tangle ./user/lang/rust/rust.nix
{ pkgs, ... }:
